        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header">MIS VENTAS-DETALLES</h1>
            ...
            <div class="row">
                <div class="col-lg-12">
                 ...
                 <div class="table-responsive"><!--EN CLASES-->
    <br><h2>Detalles de la venta</h2>
    <ul>
        <li>ID venta : ${det.id}</li>
        <li>Cliente : ${det.nombrecli}</li>
        <li>Fecha de la compra : ${det.fechaventa}</li>
        <li>Productos : ${det.products}</li>
        <li>Cantidad de productos:${det.cantidadprod}</li>
        <li>Total de la venta $ ${det.total}</li>
